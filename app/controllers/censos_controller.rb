class CensosController < ApplicationController
  ...
  private
    ...
    def censo_params
      params.require(:censo).permit(:numberDocumentPerson, :idOpinion, :idHealthService, :date, :numberOfChildren, :gender, :ageChildren, :originResguardo, :levelStudies, :profession, :entry)
    end
end
