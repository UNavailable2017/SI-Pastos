...
class ResidencesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create residence" do
    assert_difference('Residence.count') do
      post residences_url, params: { residence: { address: @residence.address, locality: @residence.locality, neighborhood: @residence.neighborhood, phone: @residence.phone } }
    end
  ...
  test "should update residence" do
    patch residence_url(@residence), params: { residence: { address: @residence.address, locality: @residence.locality, neighborhood: @residence.neighborhood, phone: @residence.phone } }
