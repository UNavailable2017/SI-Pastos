...
class WorkGroupsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create work_group" do
    assert_difference('WorkGroup.count') do
      post work_groups_url, params: { work_group: { cabildo: @work_group.cabildo, idGroup: @work_group.idGroup, participant: @work_group.participant, proyect: @work_group.proyect } }
    end
  ...
  test "should update work_group" do
    patch work_group_url(@work_group), params: { work_group: { cabildo: @work_group.cabildo, idGroup: @work_group.idGroup, participant: @work_group.participant, proyect: @work_group.proyect } }
