...
class AnnouncementsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create announcement" do
    assert_difference('Announcement.count') do
      post announcements_url, params: { announcement: { deadline: @announcement.deadline, publicationDate: @announcement.publicationDate } }
    end
  ...
  test "should update announcement" do
    patch announcement_url(@announcement), params: { announcement: { deadline: @announcement.deadline, publicationDate: @announcement.publicationDate } }
