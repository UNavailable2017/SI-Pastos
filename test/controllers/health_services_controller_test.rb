...
class HealthServicesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create health_service" do
    assert_difference('HealthService.count') do
      post health_services_url, params: { health_service: { admissionDate: @health_service.admissionDate, departureDate: @health_service.departureDate, name: @health_service.name, regime: @health_service.regime } }
    end
  ...
  test "should update health_service" do
    patch health_service_url(@health_service), params: { health_service: { admissionDate: @health_service.admissionDate, departureDate: @health_service.departureDate, name: @health_service.name, regime: @health_service.regime } }
