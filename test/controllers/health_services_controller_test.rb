...
class HealthServicesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create health_service" do
    assert_difference('HealthService.count') do
      post health_services_url, params: { health_service: { censo_id: @health_service.censo_id, idHealthService: @health_service.idHealthService, name: @health_service.name } }
    end
  ...
  test "should update health_service" do
    patch health_service_url(@health_service), params: { health_service: { censo_id: @health_service.censo_id, idHealthService: @health_service.idHealthService, name: @health_service.name } }
