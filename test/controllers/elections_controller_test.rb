...
class ElectionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create election" do
    assert_difference('Election.count') do
      post elections_url, params: { election: { date: @election.date, idElection: @election.idElection, winner: @election.winner } }
    end
  ...
  test "should update election" do
    patch election_url(@election), params: { election: { date: @election.date, idElection: @election.idElection, winner: @election.winner } }
